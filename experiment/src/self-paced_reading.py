...
from show_stim import show_fixation, show_text, show_word, show_blackscreen
...
def experiment(paths: dict, fixation_time: int, blackscreen_time: int):
    ...
    df.to_csv(os.path.join(paths["out_data"], "data.csv"))  # change path!
...
if __name__ == "__main__":
    ...
    paths = {
        ...
        "stories": os.path.join("..", "stories", "*"),
        "questions": os.path.join("..", "questions.csv"),
